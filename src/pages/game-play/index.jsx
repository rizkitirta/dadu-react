...
function Game() {
  ...
  return (
    <div>
      ...
      <h1 className="font-bold text-2xl my-10">Maintenance!</h1>
      <img src="/dadu.png" className="max-w-sm  mx-auto my-20 animate-bounce mt-36" />

      {/* Dadu */}
      <div className="flex justify-center gap-4 my-10">
        <div className="block p-5 rounded-lg shadow-2xl bg-white max-w-sm grid grid-cols-3 gap-2 animate-pulse">
